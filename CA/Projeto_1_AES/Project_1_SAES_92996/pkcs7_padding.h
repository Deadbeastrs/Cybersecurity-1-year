 ...
 */
int pkcs7_padding_pad_buffer( uint8_t *buffer,  uint32_t data_length, uint32_t buffer_size, uint8_t modulus );

int pkcs7_padding_valid( uint8_t *buffer, uint32_t data_length, uint32_t buffer_size, uint8_t modulus );
 ...
 */
uint32_t pkcs7_padding_data_length( uint8_t * buffer, uint32_t buffer_size, uint8_t modulus );
