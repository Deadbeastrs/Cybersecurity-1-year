...
void DO_ENC_BLOCK(__m128i* m,__m128i* k){
...
void DO_DEC_BLOCK(__m128i* m,__m128i* k){
...
static int aes128_self_test(void){
    uint8_t plain[]      = {0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36};
