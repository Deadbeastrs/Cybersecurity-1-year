        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            <div class='col-md-4'>
                    <div class='panel panel-info'>
                        ...
                        <div class='panel-body'> <img src='uploads/$pro_image' style='width:160px; height:250px;/></div>
        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            if (isset($_POST["get_cart_product"])) {
                ...
                <div class='row'>
                    ...
                    <div class='col-md-3'><img src='uploads/$pro_image' width='60px' height='50px'></div>
                ...
                <div class='row'> 
                    ...
                    <div class='col-md-2'><img src='uploads/$pro_image' width='60px' height='50px'></div>
...
$pid = mysqli_real_escape_string ($con, $_POST["removeid"]);
$uid = $_SESSION["uid"];
